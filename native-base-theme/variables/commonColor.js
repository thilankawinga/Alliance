...
export default {
  ...
  // Tab
  tabDefaultBg: blue,
  topTabBarTextColor: gold,
  topTabBarActiveTextColor: gold,
  topTabActiveBgColor: blue,
  topTabBarBorderColor: blue,
  topTabBarActiveBorderColor: gold,
